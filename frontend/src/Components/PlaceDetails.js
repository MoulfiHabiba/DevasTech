...
const PlaceDetails = () => {
  ...
  // Placeholder data
  const placePictures = [require("../Images/pic7.jpg"),require("../Images/pic8.jpg"),require("../Images/pic9.jpg"),require("../Images/pic10.jpg"),require("../Images/pic11.jpg"),];
  ...
  const events = [
      ...
      },
    {
      ...
      descriptionS: "Cet événement célèbre la musique de rue en Algérie. Des musiciens de différents genres musicaux se produisent dans les rues d'Alger, créant une atmosphère animée et festive.",
      descriptionL: "Cet événement célèbre la musique de rue en Algérie. Des musiciens de différents genres musicaux se produisent dans les rues d'Alger, créant une atmosphère animée et festive.",
  ...
  const news = [
    {
      ...
      date: "June 10, 2023",
      descriptionS: " Les rues algériennes sont également le théâtre d'initiatives environnementales. Des campagnes, des actions de nettoyage des espaces publics, des plantations d'arbres et d'autres projets écologiques ",
      descriptionL: " Les rues algériennes sont également le théâtre d'initiatives environnementales. Des campagnes de sensibilisation à la protection de l'environnement, des actions de nettoyage des espaces publics, des plantations d'arbres et d'autres projets écologiques sont menés pour promouvoir la durabilité et la préservation de l'environnement.",
    ...
    },
    {
      ...
      date: "June 12, 2023",
      descriptionS: " Des festivals de musique, de danse, de théâtre, d'arts visuels et d'autres formes d'expression artistique sont organisés dans diverses villes du pays. ",
      descriptionL: " Des festivals de musique, de danse, de théâtre, d'arts visuels et d'autres formes d'expression artistique sont organisés dans diverses villes du pays. Ces événements offrent aux habitants l'occasion de célébrer la diversité culturelle et de profiter d'activités divertissantes.",
    ...
    },
    {
      ...
      date: "June 12, 2023",
      descriptionS: "Des groupes de bénévoles se mobilisent pour venir en aide aux personnes démunies, distribuer de la nourriture et des vêtements...",
      descriptionL: "Des groupes de bénévoles se mobilisent pour venir en aide aux personnes démunies, distribuer de la nourriture et des vêtements, et soutenir les plus vulnérables de la société. Ces actions solidaires se déroulent souvent dans les rues et apportent un soutien précieux à ceux qui en ont besoin..",
  ...
  const reviews = [
    {
      ...
      title: 'super!',
      comment: "De jour comme de nuit, elle regorge d'activités et de divertissements. Les artistes de rue créent une ambiance festive et joyeuse, et les musiciens locaux ajoutent une bande-son envoûtante. Les nombreux restaurants offrent une variété de cuisines, des plats traditionnels aux spécialités internationales.",
    },
    {
      name: "Jane Smith",
      rating: 5,
      ...
      title: 'What a time!',
      date: "01-02-2023",
      comment: "Les vitrines sont magnifiquement décorées, invitant les passants à entrer et à explorer. De plus, les cafés et les terrasses sont parfaits pour faire une pause et se ressourcer tout en admirant la beauté de l'architecture environnante.",
    },
    {
      name: "Maxine theo",
      rating: 3.5,
    ...
    },
    {
      ...
      title: 'great place',
      date: "17-04-2023",
      comment: "C'est un endroit où l'on peut se perdre pendant des heures, en découvrant de nouvelles surprises à chaque coin de rue.",
    },
          ...
          <div className="px-8 mb-10 ">
            <div className="grid grid-cols-2 gap-0">
              ...
              <div className="col-span-1">
                <div style={{ backgroundColor: "rgba(240, 240, 250, 0.1)" }} className="block p-10  bg-white  rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
        ...
        <div className="mb-16">
          <div className="mt-0 p-0 ">
            ...
            <div className="flex space-x-11 ">
             ...
             >
               <div className="flex justify-center-end bg-yellow-500 rounded-2xl h-16 w-16 mb-10">
                 <h1 className="flex justify-center text-semibold text-center">{events.date}</h1>
               </div>
               <div
                 style={{ backgroundColor: "rgba(248, 248, 255, 0.8)" }}
                 className="flex justify-center rounded-3xl bg-opacity-0 "
               >
               <h4 className="text-3xl text-black font-semibold px-4">{events.title}</h4> </div>
               <div
                 style={{ backgroundColor: "rgba(248, 248, 255, 0.7)" }}
                 className="flex justify-center rounded-3xl bg-opacity-0 py-4"
               >
                 <p className="text-2xl text-black-600 text-center mt-4">{events.descriptionS}</p>
                 <a
                   href="#"
                   className="mt-5 h-15  inline-flex items-center px-3 py-2 text-xl font-medium text-center text-white bg-yellow-600 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
...
key={indexN}
             ...
             >
               <div className="flex justify-center-end bg-yellow-500 rounded-2xl h-16 w-16 mb-10">
                 <h1 className="flex justify-center text-semibold text-center">{news.date}</h1>
               </div>
               <div
                 style={{ backgroundColor: "rgba(248, 248, 255, 0.8)" }}
                 className="flex justify-center rounded-3xl bg-opacity-0 "
               >
               <h4 className="text-3xl text-black font-semibold ">{news.title}</h4> </div>
               <div
                 style={{ backgroundColor: "rgba(248, 248, 255, 0.8)" }}
                 className="flex justify-center rounded-3xl bg-opacity-0 "
               >
                 <p className="text-2xl text-black-600 text-center mt-4 py-4">{news.descriptionS}</p>
                 <a
                   href="#"
                   className="mt-5 h-15  inline-flex items-center px-3 py-2 text-xl font-medium text-center text-white bg-yellow-600 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
      ...
      {isPopupNOpen && selectednews && (
       ...
       <div style={{ backgroundColor: "rgba(248, 248, 255, 0.8)" }}  className="bg-white rounded-3xl p-8 max-w-5xl ">
            <h1 className="text-7xl font-semibold mb-2">{selectednews.title}</h1>
            <p className="text-gray-500 mb-4 text-2xl">{selectednews.date}</p>
            <p className="text-gray-800 mb-4 text-3xl">{selectednews.descriptionL}</p>
            ...
            <div className="flex justify-center">
          <button className="bg-yellow-700 rounded-2xl hover:bg-gray-800 text-3xl text-white font-semibold py-2 px-4 h-20 w-40 rounded mt-7" onClick={closePopupN}>
            Fermer
          </button>
        </div>
          </div>
      ...
      <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
      <div style={{ backgroundColor: "rgba(248, 248, 255, 0.8)" }} className="bg-white rounded-3xl p-8 max-w-5xl">
        <h1 className="text-7xl font-semibold mb-2">{selectedEvent.title}</h1>
        ...
        <p className="text-gray-800 mb-4 text-3xl mt-5">{selectedEvent.descriptionL}</p>
    
        <div className="flex justify-center">
          <button className="bg-yellow-700 rounded-2xl hover:bg-gray-800 text-3xl text-white font-semibold py-2 px-4 h-20 w-40 rounded mt-7" onClick={closePopup}>
            Fermer
          </button>
        </div>
      </div>
              ...
              <div>
                ...
                <form className="space-y-2">
                  <div>
                    ...
                    >
                      <option value={0}>Selectioner rating</option>
