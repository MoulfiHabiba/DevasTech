              ...
              <div className="flex space-x-11 ">
                ...
                {displayEvents.map((events, index) => (
                  ...
                  >
                    ...
                    >
                      <h4 className="text-3xl text-black font-semibold px-4 py-2 text-center">
                        {events.title}
                      </h4>{" "}
                    </div>
                    <div
                    ...
                    >
                      <p className="text-xl text-black-600 text-center mt-4 px-3 py-2">
                        {events.descriptionS}
                      </p>
                      <a
                        href="#"
                ...
                {displayNews.map((news, indexN) => (
                  ...
                  >
                    ...
                    <div
                      ...
                      className="flex justify-center rounded-3xl bg-opacity-0 "
                    >
                      <p className="text-xl text-black-600 text-center mt-4 py-4 px-5">
                        {news.descriptionS}
                      </p>
                      <a
                        href="#"
          ...
          <div>
            ...
            <div>
              ...
              {!authenticated && (
                ...
                <div className="bg-opacity-10 bg-white rounded-2xl p-4 space-y-2 w-90 h-90  border border-grey-400 rounded-lg shadow hover:bg-gray-100">
                  <form className="space-y-2">
                    ...
                    <label htmlFor="title" className="block font-medium text-3xl py-3">
                      ...
                      <textarea
                        ...
                        className="block  w-full py-2 px-3 text-3xl appearance-none border border-coolGray-200 rounded-lg shadow-md text-coolGray-500 leading-6 focus:outline-none focus:shadow-outline focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 placeholder-coolGray-200 resize-none"
                      ></textarea>
                      ...
                      <textarea 
                        ...
                        className="block h-32 md:h-52 w-full py-2 px-3 appearance-none border border-coolGray-200 text-2xl rounded-lg shadow-md text-coolGray-500 leading-6 focus:outline-none focus:shadow-outline focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 placeholder-coolGray-200 resize-none"
                      ></textarea>
                    </div>
                    <button
                      type="button"
